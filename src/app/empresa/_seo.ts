...
if (!_siteUrl) {
  throw new Error(
    ...
    'Configurala en Vercel → Settings → Environment Variables → NEXT_PUBLIC_SITE_URL=https://aretesoluciones.space'
  );
}
export const SITE_URL: string = _siteUrl;
...
export const SEO = {
  ...
  servicios: {
    ...
    canonical:   `${SITE_URL}/empresa/servicios`,
  },
  ...
  diagnosticoOperativo: {
    ...
    canonical:   `${SITE_URL}/empresa/servicios/diagnostico-operativo`,
  },
  ...
  softwareAMedida: {
    ...
    canonical:   `${SITE_URL}/empresa/servicios/software-a-medida`,
  },
  ...
  crmErpAMedida: {
    ...
    canonical:   `${SITE_URL}/empresa/servicios/crm-erp-a-medida`,
  },
  ...
  automatizacion: {
    ...
    canonical:   `${SITE_URL}/empresa/servicios/automatizacion-de-procesos`,
  },
  ...
  agentesIa: {
    ...
    canonical:   `${SITE_URL}/empresa/agentes-ia`,
  },
  ...
  metodologia: {
    ...
    canonical:   `${SITE_URL}/empresa/metodologia`,
  },
  ...
  nosotros: {
    ...
    canonical:   `${SITE_URL}/empresa/nosotros`,
  },
  ...
  equipo: {
    ...
    h1:          'El equipo',
    canonical:   `${SITE_URL}/empresa/equipo`,
  },
  ...
  contacto: {
    ...
    h1:          'Hablemos',
    canonical:   `${SITE_URL}/empresa/contacto`,
  },
};
...
export const SEO_FDS = {
  hub: {
    ...
    canonical:   `${SITE_URL}/fuera-de-serie`,
  },
  ...
  capacitacionEquipos: {
    ...
    canonical:   `${SITE_URL}/fuera-de-serie/capacitacion-equipos-de-venta`,
  },
  ...
  ventaConsultiva: {
    ...
    canonical:   `${SITE_URL}/fuera-de-serie/programa-venta-consultiva`,
  },
