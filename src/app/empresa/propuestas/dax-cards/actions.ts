...
export async function notifyAcceptance(): Promise<{ ok: boolean }> {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: '✅ Propuesta Dax Cards — aceptada',
      html: `
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#111;padding:40px">
  ...
  <p style="color:#666;margin-top:0">Santino revisó y aceptó la propuesta de Dax Cards.</p>
  <table style="width:100%;border-collapse:collapse;margin-top:24px">
    <tr style="background:#f5f5f5">
      <td style="padding:10px 14px;font-weight:700;width:160px">Propuesta</td>
      <td style="padding:10px 14px">Dax Cards — Agente de Soporte IA</td>
    </tr>
    <tr>
      <td style="padding:10px 14px;font-weight:700">Inversión</td>
      <td style="padding:10px 14px">USD 1.500 desarrollo + USD 150/mes mantenimiento</td>
    </tr>
    <tr style="background:#f5f5f5">
      <td style="padding:10px 14px;font-weight:700">Plazo estimado</td>
      <td style="padding:10px 14px">1 a 2 semanas desde confirmación</td>
    </tr>
    <tr>
