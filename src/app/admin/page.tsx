...
const sections = [
  ...
  { href: '/admin/evolucion', label: 'Evolución', desc: 'Seguimiento de capacidades, patrones e intervenciones por setter.', icon: TrendingUp },
  ...
  { href: '/admin/conversaciones', label: 'Conversaciones', desc: 'Evolución por setter: capacidades, patrones y aprendizajes detectados por el Motor IA.', icon: FileSearch },
  ...
  { href: '/admin/prospeccion', label: 'Prospección', desc: 'Dashboard de prospección: mensajes, respuestas, ranking.', icon: Target },
