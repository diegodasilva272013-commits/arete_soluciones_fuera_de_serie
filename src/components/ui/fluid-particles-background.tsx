...
export const FluidParticlesBackground = ({
  ...
  useEffect(() => {
    ...
    // Size canvas to container, not window
    const resizeCanvas = () => {
    ...
    const animate = () => {
      // Trail effect with brand dark background
      ...
      for (const particle of particles) {
        ...
        const opacity = Math.sin((particle.life / particle.maxLife) * Math.PI) * 0.18;
        ...
        // Areté brand: white/blue particles on dark
